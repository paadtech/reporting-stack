...
This file breaks up the original code into methods for us to utilize through the cloud scripts that are written.
"""
...
"""
This method performs the parsing needed for every sheet.
It accepts a specific file.
It outputs a dictionary of information for every specific file
"""
def parseDaysheet(daysheet):
    ...
    #try:
    # TODO: Change the method to open up the workbook. This WILL be different with googlesheets
    wkbk = xlrd.open_workbook(daysheet)
    ...
    try:
        ...
        # for now, I will simply just print the daily_info dictionary
        # TODO: on server, we need to change this to open and append to the master files.
    #except:
    #    pass

def main():
    # main is ued for testing purposes, and predominantly on local machines.

    # open csv in append mode
    skeleton = open("master_file.csv", "a")
